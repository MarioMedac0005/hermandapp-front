  ...
  return (
    <div className="mt-10 mx-5">
      ...
      <div className="flex justify-center mt-6">
        <div className="join">
          <input className="join-item btn btn-square bg-purple-600" type="radio" name="page" aria-label="1" defaultChecked />
          <input className="join-item btn btn-square" type="radio" name="page" aria-label="2" />
