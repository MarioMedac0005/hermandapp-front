...
function HermandadPerfil() {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="container mx-auto px-6 py-8 flex flex-col lg:flex-row space-y-8 lg:space-y-0 lg:space-x-8">
        ...
        <div className="lg:w-2/3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="bg-white p-6 rounded-xl shadow-lg text-center flex flex-col justify-center">
              <CalendarDaysIcon className='w-10 h-10 mx-auto mb-4 text-purple-600' />
              <p className="text-gray-500 font-medium">Año de Fundación</p>
              <p className="text-2xl font-bold text-purple-600">1595</p>
            </div>

            <div className="bg-white p-6 rounded-xl shadow-lg text-center flex flex-col justify-center">
              <UserCircleIcon className='w-10 h-10 mx-auto mb-4 text-purple-600' />
              <p className="text-gray-500 font-medium">N° de Nazarenos</p>
              <p className="text-2xl font-bold text-purple-600">3.500</p>
            </div>

            <div className="bg-white p-6 rounded-xl shadow-lg text-center">
              <MapPinIcon className='w-10 h-10 mx-auto mb-4 text-purple-600' />
              <p className="text-gray-500 font-medium">Sede Canónica</p>
              <p className="text-2xl font-bold text-purple-600">Basílica de la Macarena</p>
            </div>
          </div>
        ...
        <aside className="lg:w-1/3 space-y-8">
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg">
            ...
            <div className="flex items-center space-x-3 mb-3 text-gray-600">
                ...
                <a href="#" className="hover:text-purple-600">hermandaddelamacarena.es</a>
            </div>
            
            <div className="flex items-center space-x-3 mb-3 text-gray-600">
                <EnvelopeIcon className='w-5 h-5 text-purple-600' />
                <a href="mailto:secretaria@hermandaddelamacarena.es" className="hover:text-purple-600">secretaria@hermandaddelamacarena.es</a>
            </div>
            
            <div className="flex items-center space-x-3 text-gray-600">
                <PhoneIcon className='w-5 h-5 text-purple-600' />
                <span className="font-medium">954 90 18 00</span>
            </div>
          </div>
          ...
          <div className="bg-purple-700 text-white p-6 rounded-xl shadow-lg">
            ...
            <button className="flex items-center justify-center w-full py-3 px-4 bg-white text-purple-700 font-semibold rounded-lg hover:bg-gray-100 transition duration-150">
              Contratar Bandas 
            </button>
          </div>
        </aside>
      ...
      <div className="container mx-auto px-6 py-8"> 
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-12">
          ...
          <div className="bg-gray-700 h-64 rounded-lg shadow-md col-span-1 hidden md:block"></div> 
          ...
          <div className="bg-gray-800 h-64 rounded-lg shadow-md col-span-1 hidden md:block"></div> 
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white p-4 rounded-lg shadow-md border-l-4 border-purple-600">
            <p className="text-lg font-semibold text-purple-700 mb-1">Paso de Misterio de Nuestro Padre Jesús de la Sentencia</p>
            <p className="text-gray-600 text-sm">Acompañamiento musical: Banda de Cornetas y Tambores de la Centuria Romana Macarena.</p>
          </div>
          
          <div className="bg-white p-4 rounded-lg shadow-md border-l-4 border-purple-600">
            <p className="text-lg font-semibold text-purple-700 mb-1">Paso de Palio de María Santísima de la Esperanza Macarena</p>
            <p className="text-gray-600 text-sm">Acompañamiento musical: Sociedad Filarmónica Nuestra Señora del Carmen de Salteras.</p>
          </div>
        </div>
