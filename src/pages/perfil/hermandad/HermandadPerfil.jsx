        ...
        <div className="flex flex-col lg:flex-row space-y-8 lg:space-y-0 lg:space-x-8">
          <div className="lg:w-2/3">
            ...
            <div className="text-gray-800 leading-relaxed space-y-4 text-base">
              <p>
                La Hermandad de la Macarena fue fundada en 1595 en el Monasterio
                de San Basilio por hortelanos. A lo largo de su historia ha
                residido en diversas sedes, consolidándose como una de las
                cofradías con mayor devoción popular de Sevilla. Su patrimonio
                artístico es incalculable, destacando la imagen de María
                Santísima de la Esperanza Macarena Coronada, anónima del siglo
                XVII, y Nuestro Padre Jesús de la Sentencia.
              </p>
              <p>
                La madrugada del Viernes Santo, la hermandad realiza su estación
                de penitencia a la Santa Iglesia Catedral, en un recorrido que
                congrega a miles de fieles y devotos venidos de todas partes del
                mundo.
              </p>
            </div>
          </div>
          ...
          <aside className="lg:w-1/3 space-y-8">
            <div className="bg-white p-6 rounded-xl shadow-lg">
              ...
              <div className="flex flex-wrap items-center space-x-3 mb-3 text-gray-600">
                ...
                <a
                  href="mailto:secretaria@hermandaddelamacarena.es"
                  className="hover:text-purple-600 text-sm sm:text-base"
                >
                  secretaria@hermandaddelamacarena.es
                </a>
              </div>
            ...
            <div className="bg-purple-700 text-white p-6 rounded-xl shadow-lg">
              ...
              <Link to='/hermandades/contratatos/crear' className="">
                <button className="flex items-center justify-center w-full py-3 px-4 bg-white text-purple-700 font-semibold rounded-lg hover:bg-gray-100 text-sm hover:cursor-pointer hover:-translate-y-1 transition-all duration-300">
                  Contratar Bandas
                </button>
              </Link>
            </div>
        ...
        <div className="space-y-4">
          <div className="bg-white p-4 rounded-lg shadow-md border-l-4 border-purple-600">
            <p className="text-base sm:text-lg font-semibold text-purple-700 mb-1">
              Paso de Misterio de Nuestro Padre Jesús de la Sentencia
            </p>
            <p className="text-xs sm:text-sm text-gray-600">
              Acompañamiento musical: Banda de Cornetas y Tambores de la
          ...
          <div className="bg-white p-4 rounded-lg shadow-md border-l-4 border-purple-600">
            <p className="text-base sm:text-lg font-semibold text-purple-700 mb-1">
              Paso de Palio de María Santísima de la Esperanza Macarena
            </p>
            <p className="text-xs sm:text-sm text-gray-600">
              Acompañamiento musical: Sociedad Filarmónica Nuestra Señora del
              Carmen de Salteras.
            </p>
          </div>
        </div>
