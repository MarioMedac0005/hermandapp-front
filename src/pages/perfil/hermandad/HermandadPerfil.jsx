...
import Galeria from '../hermandad/assets/galeria.webp'
    ...
    <div className="min-h-screen bg-white-100">
      ...
      <div className="container mx-auto px-6 py-8 max-w-7xl">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-12">
          ...
          <div className="relative h-48 rounded-lg shadow-md col-span-1 overflow-hidden">
            <img src={Galeria} className="absolute inset-0 w-full h-full object-cover" />
          </div>
          ...
          <div className="relative h-48 rounded-lg shadow-md col-span-2 sm:col-span-1 overflow-hidden">
            <img src={Galeria} className="absolute inset-0 w-full h-full object-cover" />
          </div>
