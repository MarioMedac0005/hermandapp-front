...
const Map = forwardRef(function Map(
	...
	useEffect(() => {
		...
		const handleMapClick = (e) => propsRef.current.onClick?.(e);
...
function MarkerContent({
	...
	return createPortal(<div className={cn("relative cursor-pointer", className)} {...props}>
...
function ControlGroup({
	...
	return (
		<div
			className="flex flex-col rounded-md bg-background shadow-sm overflow-hidden">
			{children}
		</div>
	);
}
