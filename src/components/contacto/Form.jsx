...
export default function Form() {
  return (
    <div className="bg-white p-8 rounded-2xl border border-[#dbcfe7]/50 shadow-lg shadow-purple-900/5">
      <h3 className="text-2xl font-bold mb-2 text-[#4a236a]">Escríbenos</h3>
      ...
      <form className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="flex flex-col gap-2">
            <label className="text-sm font-bold text-[#4a236a]">Nombre Completo</label>
          ...
          <div className="flex flex-col gap-2">
            <label className="text-sm font-bold text-[#4a236a]">Correo Electrónico</label>
        ...
        <div className="flex flex-col gap-2">
          <label className="text-sm font-bold text-[#4a236a]">Asunto</label>
        ...
        <div className="flex flex-col gap-2">
          <label className="text-sm font-bold text-[#4a236a]">Mensaje</label>
        ...
        <button type="submit" className="w-full bg-[#4a236a] hover:bg-[#5e3d7d] text-white font-bold py-4 rounded-xl transition-all shadow-lg shadow-purple-900/10 hover:shadow-purple-900/20 flex items-center justify-center gap-2 transform active:scale-[0.99]">
          Enviar Mensaje
        </button>
      </form>
    </div>
