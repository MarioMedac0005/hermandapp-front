        ...
        <div className="card bg-base-100 shadow-2xl border border-base-200 overflow-hidden rounded-2xl">
            <div className="card-body p-8 sm:p-12">
                <header className="mb-4">
                    ...
                    <div className="mt-2 text-base sm:text-lg font-medium text-base-content/40 leading-relaxed max-w-3xl">
                        {subtitle}
                    </div>
                </header>
                ...
                <div className="flex items-center justify-between pt-10 border-t border-base-100">
                    <button
                        type="button"
